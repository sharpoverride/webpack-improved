...
declare module "react-bootstrap" {
    ...
    interface DropdownOnSelectHandler{
        (eventKey:string, event: React.SyntheticEvent):void
    }
    // <DropdownButton />
    // ----------------------------------------
  ...
  interface ModalHeaderProps extends React.HTMLAttributes {
    ...
    var FormGroup: StaticClass;
    var ControlLabel: StaticClass;

    // <Forms />
    // -----------------------
    var Checkbox: StaticClass;
    var Radio: StaticClass;
    var HelpBlock: StaticClass;
